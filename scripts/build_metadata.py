...
def build_metadata_from_folder(images_dir: Path, metadata_path: Path, limit: int | None = None) -> None:
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="Only include the first N images (for quick CPU test runs before the full dataset).",
    )
    ...
    build_metadata_from_folder(images_dir, metadata_path, limit=args.limit)
